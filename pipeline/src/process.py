...
class WindProcessor:
    ...
    def process_step(self, u_path, v_path, time_key, png_filename):
        ...
        img_array[grid_data >= 24.3] = [0, 0, 255, 255]
        img_array[grid_data < 24.3]  = [153, 0, 204, 255]
        img_array[grid_data < 19.4]  = [255, 51, 153, 255]
        img_array[grid_data < 14.6]  = [255, 0, 0, 255]
        img_array[grid_data < 12.5]  = [255, 85, 0, 255]
        img_array[grid_data < 10.0]  = [209, 158, 0, 255]
        img_array[grid_data < 9.0]   = [255, 255, 0, 255]
        img_array[grid_data < 8.0]   = [153, 255, 0, 255]
        img_array[grid_data < 7.0]   = [0, 204, 0, 255]
        img_array[grid_data < 6.0]   = [0, 255, 204, 255]
        img_array[grid_data < 5.0]   = [0, 191, 255, 255]
        img_array[grid_data < 3.0]   = [230, 255, 255, 255]
